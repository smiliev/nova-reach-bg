...
const resources = {
  bg: {
    translation: {
      ...
      hero: {
        tagline: "Уморени сте от агенции, които обещават много, но не носят реални резултати.",
        subtitle: "Ние анализираме, поправяме и оптимизираме всяка стъпка от вашия маркетинг канал, за да превърнем разхода в печалба.",
      ...
      contact: {
        ...
        promo: {
          title: "Премиум Бонус пакет за нови партньори",
          intro: "За да покажем, че ценим своите клиенти, ние сме изготвили Премиум Бонус пакет за нови партньори, който включва:",
          service1: "представително видео",
          ...
          totalPrice: "940 лв",
          newPartnerPrice: "Цена за нови партньори:",
          freePrice: "0 лв"
        },
        form: {
          name: "Име",
  ...
  en: {
    translation: {
      ...
      contact: {
        ...
        promo: {
          title: "Premium Bonus Package for New Partners",
          intro: "To show we value our clients, we've prepared a Premium Bonus Package for new partners, which includes:",
          service1: "promotional video",
          service1Price: "150 BGN",
          service2: "business plan based on your niche",
          service2Price: "400 BGN",
          service3: "business card design or basic logo",
          service3Price: "70 BGN",
          service4: "development direction consultation",
          service4Price: "320 BGN",
          totalValue: "Total Value:",
          totalPrice: "940 BGN",
          newPartnerPrice: "Price for New Partners:",
          freePrice: "0 BGN"
        },
        form: {
          name: "Name",
